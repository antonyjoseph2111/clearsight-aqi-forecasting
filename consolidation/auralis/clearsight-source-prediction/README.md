...
│   ├── stubble_score.py           # Stubble burning attribution
│   ├── traffic_score.py           # Traffic attribution
│   ├── industry_score.py          # Industry attribution
│   ├── dust_score.py              # Dust attribution
│   ├── trapping_score.py          # Meteorological trapping
│   ├── attribution_engine.py      # Main orchestration
│   └── data_loader.py             # Load and merge all data sources
│
├── validation/
│   ├── sanity_checks.py           # Basic correctness tests
│   ├── known_events.py            # Test against Diwali, dust storms
│   ├── temporal_patterns.py       # Rush hour, seasonal patterns
│   └── correlation_tests.py       # Score vs indicator correlations
│
├── api/
│   └── app.py                     # Flask/FastAPI REST API
│
├── outputs/
│   └── attribution_results/       # Generated JSON outputs
│
├── requirements.txt
└── README.md
```
